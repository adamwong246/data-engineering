  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved purchaser as @purchaser" do
        ...
        post :create, {:purchaser => { "name" => "invalid value" }}, valid_session
        assigns(:purchaser).should be_a_new(Purchaser)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested purchaser" do
        ...
        Purchaser.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => purchaser.to_param, :purchaser => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the purchaser as @purchaser" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Purchaser.any_instance.stub(:save).and_return(false)
        put :update, {:id => purchaser.to_param, :purchaser => { "name" => "invalid value" }}, valid_session
        assigns(:purchaser).should eq(purchaser)
      end
