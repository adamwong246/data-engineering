...
describe PurchasesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      describe "a tab-delimited file" do
        it "creates multiple new Purchases", focus: true do
          expect { 
            post :create, {:purchase => {csv: fixture_file_upload('example_input.tab', 'text/csv')}}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested purchase" do
        ...
        Purchase.any_instance.should_receive(:update_attributes).with({ "count" => "1" })
        put :update, {:id => purchase.to_param, :purchase => { "count" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the purchase as @purchase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Purchase.any_instance.stub(:save).and_return(false)
        put :update, {:id => purchase.to_param, :purchase => { "count" => "invalid value" }}, valid_session
        assigns(:purchase).should eq(purchase)
      end
